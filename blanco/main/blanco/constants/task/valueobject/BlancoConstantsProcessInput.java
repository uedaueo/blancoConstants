...
public class BlancoConstantsProcessInput {
     ...
     */
    public void copyTo(final BlancoConstantsProcessInput target) {
        if (target == null) {
            throw new IllegalArgumentException("Bug: BlancoConstantsProcessInput#copyTo(target): argument 'target' is null");
        }
